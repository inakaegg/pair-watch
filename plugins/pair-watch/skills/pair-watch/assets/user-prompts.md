...
- codex-invoked: "This Codex chat has no explicit Codex peer, so the Claude-watcher flow applies. Please wait for the inbox file the watcher will deliver, then follow it."
