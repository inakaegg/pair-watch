...
5. Before commit/PR, request the independent implementation review (gate 3) via the outbox. Local commits only after the inbox conveys `VERDICT: LGTM`.
